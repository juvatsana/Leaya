    ...
    <Grid container style={{ justifyContent: 'center', color: 'white'}} alignItems="center" justifyContent="center" className='p-0 py-10 m-0 overflow-hidden' height="100%">
        ...
        <Grid item sm={12} md={6} className="relative flex-col text-justify p-10 md:text-2xl ">
            ...
            <p style={{fontSize: "24px", paddingBottom: '2rem'}}>
                <span style={{ color: '#B18F40' }}>LEAYA ELITE garantit la sécurité et la confidentialité auprès de ces utilisateurs 
                afin d’offrir une expérience fiable et agréable.</span><br/><br/>
                De la protection des données personnelles à la vérification des profils utilisateurs 
                en passant par la confidentialité des informations personnelles, 
                l’application promet aux utilisateurs de profiter, en toute sérénité, 
                de toutes les fonctionnalités mises à disposition.
            </p>
        </Grid>
    </Grid>
  )
